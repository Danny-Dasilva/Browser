((window, factory) => {
  ...
  const defaultTapProperties = {
    title: 'Google',
    //favicon: 'https://www.google.com/s2/favicons?domain_url=google.com&sz=24',
    favicon: 'homepage/images/loading.gif',
    id: currentTabId + 1
  }
  ...
  class ChromeTabs {
    ...
    setupEvents() {
      ...
      this.el.addEventListener("click", ({ target }) => {
        if (target.classList.contains("new-tab-button")) {
          this.addTab({
            title: 'Google',
            favicon: 'homepage/images/google-favicon.ico'
          })
        }
      })
    ...
    updateTab(tabEl, tabProperties) {
      ...
      tabEl.setAttribute('tab-id', currentTabId);
      currentTabId++;
    }
